package FixMyStreet::App::Form::Claims::AboutYou;
...
has_field email => (
    ...
    label => 'Email address',
    tags => {
        hint => 'We’ll only use this to send you updates on your claim'
    },
);
...
has_field phone => (
    ...
    tags => {
        hint => 'We will call you on this number to discuss your claim'
    },
    validate_method => sub {
        my $self = shift;
